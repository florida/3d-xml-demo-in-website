var s_tc_JonesLangDevelopment=new TagContainer('JonesLangDevelopment');
...
var SCCodeVersion="SC25.5.5"

var s_account="jll-dev";
/* set the s_account */
SetOmnitureSCAccount(); 
...
s.linkInternalFilters="javascript:,.jllproperty."
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

s.usePlugins=true
function SetOmnitureSCAccount()
{
    s_account = "jll-dev"
    //Argentina
    if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/latin_america-es-ar") > -1)  s_account = "jll-argentina, jll-global";
    //Brazil
    if (window.location.host.toLowerCase() == "www.jllproperty.com.br") s_account = "jll-brazil, jll-global";
    //canada
    if (window.location.host.toLowerCase() == "www.jllproperty.ca") s_account = "jll-canada, jll-global";
    //China
    if (window.location.host.toLowerCase() == "www.jllproperty.com.cn") s_account = "jll-china, jll-global";
    //Croatia
    if (window.location.host.toLowerCase() == "www.jllproperty.hr") s_account = "jll-croatia, jll-global";
    //Hotels
    if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/hotels-en-gb") > -1) s_account = "jll-hotels, jll-global";
    //Hungary
    if (window.location.host.toLowerCase() == "www.jllproperty.hu") s_account = "jll-hungary, jll-global";
    //India
    if (window.location.host.toLowerCase() == "www.jllproperty.co.in") s_account = "jll-india, jll-global";
    //indonesia
    if (window.location.host.toLowerCase() == "www.jllproperty.co.id") s_account = "jll-indonesia, jll-global";
    //Ireland
    if (window.location.host.toLowerCase() == "www.jllproperty.ie") s_account = "jll-ireland, jll-global";
    //Italy
    if (window.location.host.toLowerCase() == "www.jllproperty.it") s_account = "jll-italy, jll-global";
    //Korea
    if (window.location.host.toLowerCase() == "www.jllproperty.co.kr") s_account = "jll-korea, jll-global";
    //luxembourg
    if (window.location.host.toLowerCase() == "www.jllproperty.lu") s_account = "jll-luxembourg, jll-global";
    //macau
    if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/macau-zh-mo") > -1) s_account = "jll-macau, jll-global";
    //maghreb
    if (window.location.host.toLowerCase() == "www.jllproperty.ma") s_account = "jll-maghreb, jll-global";
    //mexico
    if (window.location.host.toLowerCase() == "www.jllproperty.com.mx") s_account = "jll-mexico, jll-global";
    //philippines
    if (window.location.host.toLowerCase() == "www.jllproperty.com.ph") s_account = "jll-philippines, jll-global";
    //poland
    if (window.location.host.toLowerCase() == "www.jllproperty.pl") s_account = "jll-poland, jll-global";
    //portugal
    if (window.location.host.toLowerCase() == "www.jllproperty.pt") s_account = "jll-portugal, jll-global";
    //romania
    if (window.location.host.toLowerCase() == "www.jllproperty.ro") s_account = "jll-romania, jll-global";
    //Russia
    if (window.location.host.toLowerCase() == "www.jllproperty.ru") s_account = "jll-russia, jll-global";
    //Serbia
    if (window.location.host.toLowerCase() == "www.jllproperty.rs") s_account = "jll-serbia, jll-global";
    //Singapore
    if (window.location.host.toLowerCase() == "www.jllproperty.com.sg") s_account = "jll-singapore, jll-global";
    //Slovakia
    if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/slovakia-sk-sk") > -1) s_account = "jll-slovakia, jll-global";
    //Taiwan
    if (window.location.host.toLowerCase() == "www.jllproperty.com.tw") s_account = "jll-taiwan, jll-global";
    //Thailand
    if (window.location.host.toLowerCase() == "www.jllproperty.in.th") s_account = "jll-thailand, jll-global";
    //Turkey
    if (window.location.host.toLowerCase() == "www.jllproperty.com.tr") s_account = "jll-turkey, jll-global";
    //Ukraine
    if (window.location.host.toLowerCase() == "www.jllproperty.com.ua") s_account = "jll-ukraine, jll-global";
    //Vietnam
    if (window.location.host.toLowerCase() == "www.jllproperty.com.vn") s_account = "jll-vietnam, jll-global";
	
	//ADDED BY ACCELERATION
	//Chile
	if (window.location.host.toLowerCase() == "www.jllproperty.cl") s_account = "jll-chile, jll-global";
	//Colombia
	if (window.location.host.toLowerCase() == "www.jllproperty.com.co") s_account = "jll-colombia, jll-global";
	//Czech Republic
	if (window.location.host.toLowerCase() == "www.jllproperty.cz") s_account = "jll-czechrepublic, jll-global";
	//Hong Kong
	if (window.location.host.toLowerCase() == "www.jllproperty.com.hk") s_account = "jll-hongkong, jll-global";
	//Latin America
	if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/latin_america-es-ar") > -1) s_account = "jll-latinamerica, jll-global";
	//Middle East
	if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/middle-east-en-gb") > -1) s_account = "jll-middleeast, jll-global";
	//Panama
	if (window.location.host.toLowerCase() == "www.jllproperty.com.pa") s_account = "jll-panama, jll-global";
	//Peru
	if (window.location.host.toLowerCase() == "www.jllproperty.com.pe") s_account = "jll-peru, jll-global";
	//South Africa
	if (window.location.host.toLowerCase() == "www.jllproperty.co.za") s_account = "jll-southafrica, jll-global";
	//United States
	if (window.location.host.toLowerCase() == "www.jllproperty.us") s_account = "jll-unitedstates, jll-global";
	//United States Retail
	if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/us-retail-en-us") > -1) s_account = "jll-unitedstatesretail, jll-global";
	//United States Multifamily
	if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/us-multifamily-en-us") > -1) s_account = "jll-unitedstatesmultifamily, jll-global";
	//United States Datacenters
	if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/us-datacentre-en-us") > -1) s_account = "jll-unitedstatesdatacenters, jll-global";
	//United States Life Sciences
	if (window.location.href.toLowerCase().indexOf("www.jllproperty.com/us-life_sciences-en-us") > -1) s_account = "jll-unitedstateslifesciences, jll-global";
}
...
// External Campaigns:
if(!s.campaign) s.campaign=s.getQueryParam('cmpid')    /* CHANGE TO QUERY STRING ID THAT IS USED. eg... (www.....?utm_source=12345)  */
s.campaign=s.getValOnce(s.campaign,'s_cmpid',0)	

// Internal Campaigns: 
if(!s.eVar17)
s.eVar17=s.getValOnce(s.getQueryParam('icid'),'int_campaign',30);	/* CHANGE TO QUERY STRING ID THAT IS USED. eg... (www.....?utm_source=12345)  */
...
//Previous pageName captured on errorPage	
...
s.prop8=s.getPreviousValue(s.pageName,'gpv','');

// Page URL excluding Query Strings
	s.prop10=location.protocol + "//" + location.host + location.pathname	
	s.eVar28=s.prop10
...
/* New vs Return Visits  */	
	...
	if(s.eVar30 && s.eVar30!=""){
	s.prop12=s.eVar30;
	}

/* Time Parting Plugin */	
//Prop5/Evar7 = Hour of Day			//Prop6/Evar8 = Day of Week			//Prop7/Evar9 = Weekday / Weekend
s.prop5 = s.eVar25 = s.getTimeParting('h', '-6'); 
s.prop6 = s.eVar26 = s.getTimeParting('d', '-6');
s.prop7 = s.eVar27 = s.getTimeParting('w', '-6');
	
/* Visit Number */
	s.eVar31=s.getVisitNum();
	if(s.eVar31 && s.eVar31!=""){
	s.prop13=s.eVar31;
	}

/* Pathing per Campaign */
	if(s.campaign && s.campaign!=""){
	s.prop15=s.campaign + ":" + s.pageName
	}		

// Campaign Stacking
	s.eVar32=s.crossVisitParticipation(s.campaign,'s_ev32','30','5','>','purchase',1);
}
...
{ 
  s.linkTrackVars='eVar5,eVar6';s.eVar5=s.pageName;if(s.products)
  s.eVar6=s.products.substring(1);else s.eVar6='unknown at time of referral';
...
s.visitorNamespace = "joneslang"
s.trackingServer = "joneslang.d1.sc.omtrdc.net"

s.setTagContainer("JonesLangDevelopment")
